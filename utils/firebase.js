...
// utilizing bucketName from the local-constants as it gets available to the nodejs environment instanly for this file but dotenv package takes time to access the envirnment variables
